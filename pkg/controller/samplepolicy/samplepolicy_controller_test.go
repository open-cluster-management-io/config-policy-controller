...
import (
	...
	samplepolicy "github.ibm.com/IBMPrivateCloud/multicloud-operators-policy-controller/pkg/apis/policies/v1alpha1"
...
func TestReconcile(t *testing.T) {
	...
	instance := &samplepolicy.SamplePolicy{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
