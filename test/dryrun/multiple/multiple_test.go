...
func TestMultipleObjCombo(t *testing.T) {
	t.Run("Test multiple object combo", dryrun.Run(multipleObjCombo))
}
...
func TestMultipleNsInform(t *testing.T) {
	t.Run("Test multiple namespace inform", dryrun.Run(multipleNsInfrom))
}
...
func TestMultipleNsEnforce(t *testing.T) {
	t.Run("Test multiple namespace enforce", dryrun.Run(multipleNsEnforce))
}
...
func TestMultipleObjTemp(t *testing.T) {
	t.Run("Test multiple object template", dryrun.Run(multipleObjTemp))
}
...
func TestMultipleMustNotHave(t *testing.T) {
	...
	t.Run("Test objectSelector with mustnothave and a templated name",
		dryrun.Run(multipleMustNotHave))
}
